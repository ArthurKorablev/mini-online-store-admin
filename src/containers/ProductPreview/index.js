...
function ProductPreview() {
  ...
  const{avatar, productName, category, description, price, quantity} = product;
  ...
  return (
        ...
        <div className={style.wraper}>
          <Logo className={style.logo}/>
            ...
            <div className={style.wraper_forArrow}><BsArrowLeft onClick={(e) => nav(e)} className={style.wraper_arrov}/></div>
              ...
              <div className={style.wraper_info}>
                <div className={style.product_check}><BsCheckCircle className={style.check}/>Are available</div>
